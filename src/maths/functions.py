...
class Functions:
    ...
    def Ros_der(self):
        return np.array([40 * self.x1 ** 3 + 2 * self.x1 - 2 - 40 * self.x1 * self.x2, -20 * self.x1 ** 2 + 20 * self.x2])

    def H_Ros(self):
        return np.array([[120 * self.x1 ** 2 + 2 - 40 * self.x2, -40 * self.x1], [-40 * self.x1, 20]])
    ...
    def H_g3(self):
        return np.array([[2*self.x2**3, 6*self.x1*self.x2**2], [6*self.x1*self.x2**2, 6*self.x1**2*self.x2]])
